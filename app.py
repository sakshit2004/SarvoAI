...
def main():
    ...
    st.set_page_config(page_title="Chat with websites, CSVs, PDFs, or Word Documents", page_icon="🤖")
    st.title("Chat with websites, CSVs, PDFs, or Word Documents")

    option = st.sidebar.selectbox("Choose an option", ["Chat with Website", "Chat with CSV", "Chat with PDF", "Chat with Word Document"])
    ...
    if option == "Chat with Website":
        ...
        if csv_file:
            if "csv_chat_history" not in st.session_state:
                st.session_state.csv_chat_history = [AIMessage(content="Hello, I am a bot. How can I help you?")]
            else:
                st.session_state.csv_chat_history = [AIMessage(content="Hello, I am a bot. How can I help you?")]
            ...
            if user_question:
                with st.spinner(text="In progress..."):
                    ...
                    st.session_state.csv_chat_history.append(HumanMessage(content=user_question))
                    st.session_state.csv_chat_history.append(AIMessage(content=response))
